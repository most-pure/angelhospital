...
export default function UserDetails({ data, appointmentData }: any) {
  ...
  return (
    <AdminLayout>
      <div className="appointment-page gap-x-2">
        <div className="appointment">
          <div className="appointment-header">
            <h2 className="lg:text-3xl text-sm font-bold ">Appointment</h2>
            <p className="welcome-text text-sm mt-5">
        ...
        <div className="flex py-4 px-5 shadow-[0_1px_16px_0px_rgba(0,0,0,0.16)] gap-4 rounded-2xl mt-10 w-full font-roboto">
          <div className="w-1/2 h-[36rem] border border-blackcolor-10 rounded-2xl py-14 px-12 text-colorbodytwo">
            <div className="flex flex-col gap-4 items-center justify-center">
              ...
              <div
                className={
                  data.status === "Pending"
                    ? "text-[#A5640C] bg-[#FFFDF0] h-6 w-max text-[11px] flex items-center px-3 rounded-lg -mt-2"
                    : data.status === "Taken"
                    ? "text-[#06C270] bg-[#DAFCEB] h-6 w-max text-[11px] flex items-center px-3 rounded-xl -mt-2"
                    : "text-[#C12126] bg-[#FFF0F0] h-5 w-max text-[11px] flex items-center px-1.5 rounded-xl -mt-2"
                }
              >
                {data.status}
              </div>
            </div>
            <div className="flex justify-between text-sm mt-2 table-auto">
          ...
          <div className="w-1/2 h-[36rem] pt-4 pl-5 text-colorbodytwo">
            ...
            <div className="pt-8">
              <p className=" font-medium">Other Appointment</p>
